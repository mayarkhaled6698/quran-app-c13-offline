...
class _HadithTabState extends State<HadithTab> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(image: DecorationImage(image: AssetImage(AssetImages.hadithMainBackground), fit: BoxFit.cover)),
      child: Column(
        children: [
          ...
          Expanded(
            ...
            child: CarouselSlider.builder(
              ...
              options: CarouselOptions(autoPlay: false, aspectRatio: 1, enlargeCenterPage: true, viewportFraction: 0.7, height: double.infinity),
            ),
          )
        ],
      ),
  ...
  void loadHadithFile() async {
    String fileContent = await rootBundle.loadString('assets/files/ahadith/ahadeth.txt');

    List<String> ahadith = fileContent.trim().split('#'); // this list contains 50 hadith object
