        ...
        : SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(scrollDirection: Axis.horizontal, itemBuilder: (context, index) => mostRecentSuraWidget(mostRecentSuras[index]), itemCount: mostRecentSuras.length),
                )
              ],
            ),
          );
