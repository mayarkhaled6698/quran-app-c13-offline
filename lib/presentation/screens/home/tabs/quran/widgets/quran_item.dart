...
class QuranItem extends StatelessWidget {
  const QuranItem({super.key, required this.sura, required this.mostRecentSurasKey});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ...
        Navigator.pushNamed(context, RoutesManager.suraDetails, arguments: SuraDetailsArguments(nameEn: suraNameEn, nameAr: suraNameAr, fileName: fileName, mostRecentSurasKey: mostRecentSurasKey));
      },
      child: Row(
        children: [
          Stack(
            alignment: Alignment.center,
            children: [SvgPicture.asset(SvgAssets.islamicBg), Text('${sura.suraIndex + 1}', style: AppStyles.whiteBold12)],
          ),
          const SizedBox(
            width: 24,
          ),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${sura.numberOfVerses} verses', style: AppStyles.whiteBold14),
              ],
            ),
          ),
